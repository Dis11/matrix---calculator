...
{
    public partial class Сложение : Form
    {
        public Сложение()
        {
            InitializeComponent();
        ...
        private void вПервуюТаблицуToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void воВторуюТаблицуToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenFileDialog ofd = new OpenFileDialog();
            ofd.DefaultExt = "*.xls;*.xlsx";
            ofd.Filter = "Microsoft Excel (*.xls*)|*.xls*";
